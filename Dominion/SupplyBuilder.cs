...
namespace Dominion
{
    public class SupplyBuilder
    {
        ...
        public SupplyBuilder With(IEnumerable<Card> cards)
        {
            if (cards == null)
        ...
        public SupplyBuilder WithPlayers(int playercount)
        {
            _playerCount = playercount;
            return this;
        }

        public SupplyBuilder WithSet<T>() where T: DeckSet, new()
        {
            _set = new T();
            return this;
        }

        public SupplyBuilder BasicGame()
        {
            _basicGame = true;
            return this;
        }
